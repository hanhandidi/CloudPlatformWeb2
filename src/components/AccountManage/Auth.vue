...
export default {
  ...
  data () {
    return {
      ...
      userName: '', // 扫码登录的用户名
      tokenApi: 'http://api.trunch.cn/auth/token', // 获取口令
      tokenImgApi: 'http://api.trunch.cn/auth/img/', // 获取口令对应的登录码
      tokenInfoApi: 'http://api.trunch.cn/auth/info/', // 获取口令信息
      userInfoApi: 'http://api.trunch.cn/login/getUser' // 获取用户信息
    }
  },
  created () {
    this.getToken()
